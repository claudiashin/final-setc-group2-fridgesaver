export const results_eggplant = {
    ...
    EggplantRiceSoup:{
        ...
        subtext1:"Step 1: Brown the sausage. Heat a large heavy-bottomed stockpot over medium-high heat.  Add the sliced sausage in a single layer and briefly cook for 1 to 2 minutes per side, until lightly browned. Transfer the sausage to a clean plate and set aside for later.",
        subtext2:"Step 2: Make the roux. Add the oil to the stockpot and whisk in flour until combined. Continue to cook, stirring constantly, until the mixture reaches a dark brown color (similar to milk chocolate), about 20 to 30 minutes. Sauté the veggies. Once the roux reaches the dark brown color, immediately stir in the bell peppers, celery, and onion until combined.  Continue to cook, stirring every 10 to 15 seconds, until the vegetables have softened, about 6 to 8 minutes. Add in the garlic and cook for 1 more minute, stirring constantly.",
        subtext3:"Step 3: Add in the broth. Gradually add in the chicken stock, stirring in a few cups at a time so that the broth can thicken. Then add in the tomatoes, cooked chicken, okra, Creole seasoning, thyme, cayenne, bay leaves, cooked sausage, and stir to combine. Simmer. Continue cooking until the gumbo just barely reaches a low simmer, then reduce heat to medium-low and continue simmering the soup for 5-10 minutes.",
        subtext4:"Step 4: Add the shrimp. Stir in the shrimp and cook for 2 to 3 minutes until they are opaque and cooked through.vRemove and discard the bay leaves. Taste the gumbo and season with however much salt and pepper it may need, to taste. Serve warm.",
    ...
    EggplantRiceDry:{
        ...
        subtext2:"Step 2: Preheat oil in a 12-inch oven-safe skillet over medium-high heat. Add eggplant and stir to coat with the oil. The eggplant may soak up all of the oil; this is normal. Add 1 teaspoon of the salt and continue to saute for five minutes, until the eggplant has softened.",
        ...
        subtext4:"Step 4: Place in the oven, uncovered, and bake for thirty minutes, or until all the liquid has been absorbed. Remove from oven and let cool slightly. Taste and adjust seasoning if necessary. Garnish with parsley and serve.",
        prep1:"Prep Time: 10 minutes",
    ...
    EggplantNoodleSoup:{
        ...
        subtext1:"Step 1: Start by preparing the vegetables. Heat 2 tablespoons of coconut oil in a large skillet over medium-high heat. Place the tofu in the hot oil and pan-fry for 3-5 minutes, until tofu is brown on all sides. Remove from heat and set aside.",
        subtext2:"Step 2: Heat the remaining 1 tablespoon of coconut oil in a large soup pot over medium-high heat. Add the onions and garlic and saute for 3-5 minutes, until the onions are translucent and fragrant. Stir in the ginger and sauté for an additional minute. Add the bell pepper and eggplant and continue to sauté for an additional 2-3 minutes until eggplant begins to brown.",
        subtext3:"Step 3: Stir in the red curry paste until the vegetables are fully coated. Add the tofu, vegetable broth, and coconut milk to the soup pot. Bring soup to a boil and then reduce heat to a simmer and simmer for 3-5 minutes.",
        subtext4:"Step 4: Add brown rice noodles and continue to cook the soup until the noodles are tender, about an additional 4 minutes. Remove from heat and add lime juice, salt, cilantro, and basil. Serve immediately with lime wedges.",
    ...
    EggplantNoodleDry:{
        ...
        subtext1:"Step 1: Slice the eggplants into batons, around 3 inches in length and 1 inch thick. In a pot, heat enough water to cook the noodles. Once it boils, add in the noodes and cook until half-cooked and chewy. Remove from the water and set aside.",
